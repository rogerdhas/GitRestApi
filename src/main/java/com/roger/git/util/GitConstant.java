...
public class GitConstant {
    ...
    public static final String TOP_CONTRIBUTORS="top10contributors";

    //Error msgs
    public static final String USER_REQ = "Git owner cannot be empty";
    ...
    public static final String REPO_USER_REQ= "Git owner or repository cannot be empty";
    public static final String INVALID_URL="Invalid Api url";
    public static final String TYPE_REQ="Type parameter needed";
